...
const stairsData = {
  ...
  f3: [
    { f_1: [{ img: ['f3_0'], t1: '', t2: '', price:'5,299元' }, { img: ['f1_1'], t1: '', t2: '' }] },
    { f_2: [{ img: ['f3_c1_0'], t1: '家庭亲情网', t2: '家庭沟通专享，亲情欢乐随行', price:'1,899元'  }, { img: ['f3_c1_1'], t1: '宽带办理', t2: '百兆宽带 更快更好' }] },
    { f_3: [{ img: ['f3_c2_0'], t1: '流量可选包', t2: '流量包随心用' }, { img: ['f3_c2_1'], t1: '流量加油包', t2: '充流量就到这里' }]},
    { f_4: [{ img: ['f3_c3_0'], t1: '有品智能体脂秤', t2: '蓝牙APP控制 家用电子秤' }, { img: ['f3_c3_1'], t1: '流量加油包', t2: '充流量就到这里' }] },
